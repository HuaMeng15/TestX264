...
def DrawFrameSize(output_dir, bitrate_indexes, network_bandwidths, bitrate_category, start_index=0, end_index=10000):
    ...
    plt.grid()
    plt.tight_layout()
    output_file = f'{bitrate_category}_frame_size.png'
...
if __name__ == "__main__":
    ...
    bitrates = ['10to1']
    bitrate_category_lists = ['0.04', '0.5']
    ...
    for bitrate in bitrates:
        ...
        for bitrate_category in bitrate_category_lists:
            ...
            DrawFrameSize(result_dir, bitrate_indexes, network_bandwidths, bitrate_category, 60, 150)
