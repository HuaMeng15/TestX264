...
def calc_delay(result_dir, bitrate_file, fps):
    ...
    transmitted_bytes_per_ms /= 0.8  # consider 80% efficiency
...
if __name__ == "__main__":
    ...
    f_every_trail.write(f'{cfg.data},{cfg.bitrate},{strategy},{avg_delay},{get_tail_result(delay[start_index:end_index], 0.9)},{avg_vmaf},{avg_psnr}\n')